                            ...
                            <div class="login-form">
                                ...
                                <form method="POST" action="/category/{{ $category->id }}">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Nama Kategori" value="{{ old('name', $category->name) }}" required>
                                        @error('name')<div id="validationName" class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="code" class="form-control @error('code') is-invalid @enderror" id="code" placeholder="Kode Kategori" value="{{ old('code', $category->code) }}" required>
